    ...
    <div className="pt-20 overflow-hidden">
      ...
      <section className="relative min-h-[60vh] flex items-center overflow-hidden bg-gradient-to-br from-primary-blue via-primary-blue-dark to-gray-900">
        ...
        >
          ...
          />
          <motion.div
            className="absolute bottom-20 left-20 w-96 h-96 bg-primary-blue/20 rounded-full blur-3xl"
            animate={{
              scale: [1, 1.3, 1],
              x: [0, -30, 0],
              y: [0, -50, 0],
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-7xl mx-auto">
            ...
            <AnimatedSection direction="right" delay={0.2}>
              <motion.div
                whileHover={{ y: -5 }}
                className="premium-card p-10 lg:p-12"
                id="form"
              >
                <div className="mb-8">
                  <motion.div
                    whileHover={{ scale: 1.1 }}
                    className="inline-block px-4 py-2 bg-primary-orange/10 rounded-full mb-4"
                  >
                ...
                <AnimatePresence>
                  {submitted && (
                    <motion.div
                      ...
                      className="mb-6 bg-gradient-to-r from-green-500 to-green-600 text-white p-6 rounded-2xl shadow-lg"
                    >
              ...
              <div className="space-y-8">
                ...
                >
                  <div className="mb-8">
                    <motion.div
                      whileHover={{ scale: 1.1 }}
                      className="inline-block px-4 py-2 bg-primary-blue/10 rounded-full mb-4"
                    >
                    ...
                    {[
                      ...
                      >
                        <motion.div
                          ...
                          className={`w-16 h-16 bg-gradient-to-br ${item.gradient} rounded-2xl flex items-center justify-center text-white flex-shrink-0 shadow-lg`}
                        >
                          {item.icon}
                        </motion.div>
                        <div>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <motion.div
                        ...
                        className="flex justify-between items-center p-4 bg-gray-50 rounded-xl transition-colors"
                      >
            ...
            <div className="relative h-[500px] rounded-3xl overflow-hidden shadow-2xl max-w-6xl mx-auto">
              ...
              >
                <motion.div
                  ...
                  className="bg-white/95 backdrop-blur-md rounded-3xl p-8 shadow-2xl text-center max-w-md mx-4"
                >
