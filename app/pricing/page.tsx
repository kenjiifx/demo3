  ...
  return (
    <div className="pt-20 overflow-hidden">
      ...
      <section className="relative min-h-[60vh] flex items-center overflow-hidden bg-gradient-to-br from-primary-blue via-primary-blue-dark to-gray-900">
        ...
        >
          <motion.div
            className="absolute top-20 left-20 w-96 h-96 bg-primary-orange/20 rounded-full blur-3xl"
            animate={{
              scale: [1, 1.4, 1],
              x: [0, 50, 0],
              y: [0, 30, 0],
        ...
        <div className="container-custom relative z-10 text-center text-white">
          ...
          <motion.p
            ...
            className="text-2xl md:text-3xl text-blue-100 font-bold max-w-3xl mx-auto"
          >
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {plans.map((plan, index) => (
              ...
              >
                <motion.div
                  whileHover={{ y: -10, scale: plan.popular ? 1.08 : 1.05 }}
                  className={`relative premium-card p-8 lg:p-10 ${
                    plan.popular ? 'lg:scale-110 z-10 border-4 border-primary-orange' : 'border-2 border-gray-200'
                  }`}
                >
                  {plan.badge && (
                    <motion.div
                      ...
                      className={`absolute -top-5 left-1/2 transform -translate-x-1/2 bg-gradient-to-r ${plan.gradient} text-white px-6 py-2 rounded-full text-sm font-black shadow-xl`}
                    >
                      {plan.badge}
                    </motion.div>
                  )}
                  ...
                  <div className="text-center mb-8">
                    <motion.h2
                      ...
                      className="text-3xl font-black mb-3 text-gray-900"
                    >
                      {plan.name}
                    </motion.h2>
                    <motion.div
                    ...
                    {plan.features.map((feature, i) => (
                      ...
                      >
                        <motion.div
                          ...
                          className={`flex-shrink-0 w-6 h-6 rounded-lg bg-gradient-to-br ${plan.gradient} flex items-center justify-center mt-0.5`}
                        >
                  ...
                  >
                    <Link
                      href="/contact"
                      className={`block w-full text-center py-4 px-6 rounded-full font-black text-lg transition-all duration-300 shadow-lg hover:shadow-xl ${
                        plan.popular
      ...
      <section className="section-padding relative overflow-hidden bg-gradient-to-br from-primary-blue via-primary-blue-dark to-gray-900">
        ...
        <div className="container-custom relative z-10">
          <AnimatedSection direction="fade" className="max-w-5xl mx-auto text-center mb-16">
            ...
            {[
              {
                ...
                description: 'Get your first month at 50% off when you sign up for any annual plan. That\'s a savings of up to $40!',
                highlight: '50% off'
              },
              {
                icon: (
                ...
                description: 'Students with valid ID receive 20% off all membership plans. Show your student ID at sign-up.',
                highlight: '20% off'
              }
            ].map((item, i) => (
              <AnimatedSection key={i} delay={i * 0.2} direction="up">
                ...
                >
                  <motion.div
                    ...
                    className="w-16 h-16 bg-primary-orange rounded-2xl flex items-center justify-center mb-6 mx-auto text-white"
                  >
                    {item.icon}
                  </motion.div>
                  ...
                  <p className="text-xl text-blue-100 leading-relaxed">
                    ...
                    <span className="text-primary-orange font-black">{item.highlight}</span>
          ...
          <AnimatedSection direction="fade" className="text-center">
            <motion.p
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="text-2xl mb-8 text-blue-100 font-bold"
            >
